<template>
<div :class="[{root: true, sidebarClose, sidebarStatic}, 'POS']">
  <Sidebar />
  <div class="wrap">
    <Header />
    <v-touch class="content" @swipe="handleSwipe" :swipe-options="{direction: 'horizontal'}">
      ...
      <footer class="contentFooter">
        POS OpenAPI - Made by <a href="https://www.POSyariah.co.id/" rel="nofollow noopener noreferrer" target="_blank">POSyariah</a>
      </footer>
    </v-touch>
  </div>
</div>
