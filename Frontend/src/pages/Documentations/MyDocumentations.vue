<template>
  <div class="mydocumentations-page">
        ...
        >
            ...
            <li>Flow POS OpenAPI
              <div class="row">
                <div class="col-md-8 p-2 grey">
                  <img src="../../assets/images/doc/myflow-openapi.png" class="img-fluid mx-auto" alt="...">
                </div>
              </div>
            </li>
          </ul>
          <p><strong>Roles Tenant</strong></p>
          <p>Features:</p>
          <p>Tenant Profile</p>
          <p style="margin-left: 20px;">Deskripsi: Profile tenant user</p>
          <ul>
            <li>Edit Profile
              <div class="row">
                <div class="col-md-8 p-2 grey">
                  <img src="../../assets/images/doc/myprofile.png" class="img-fluid mx-auto" alt="...">
                </div>
              </div>
            </li>
            <li>Change password&nbsp;</li>
          </ul>
          <p>Create Apps for tenant</p>
          <p style="margin-left: 20px;">Deskripsi: Registration for new apps</p>
          <ul>
            <li>Apps List
              <div class="row">
                <div class="col-md-8 p-2 grey">  
                  <img src="../../assets/images/doc/myapps_list.png" class="img-fluid mx-auto" alt="...">
                </div>
              </div>
            </li>
            <li>New Apps
              <div class="row">
                <div class="col-md-8 p-2 grey">  
                  <img src="../../assets/images/doc/mynew_apps.png" class="img-fluid mx-auto" alt="...">
                </div>
              </div>
            </li>
          </ul>
          ...
          <ul>
            <li>SIT API document request (SIT)
              <div class="row">
                <div class="col-md-8 p-2 grey">  
                  <img src="../../assets/images/doc/mynew_sit.png" class="img-fluid mx-auto" alt="...">
                </div>
              </div>
            </li>
            ...
            <div class="row">
                <div class="col-md-8 p-2 grey">  
                  <img src="../../assets/images/doc/mysit_list.png" class="img-fluid mx-auto" alt="...">
                </div>
              </div>
            </li>
          </ul>
